...
For the full reference — env-var table, systemd unit example, working broker config for both **Mosquitto** and **EMQX**, and the threat model — see [docs/security.md](docs/security.md).
